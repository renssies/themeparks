...
class Ride {
     ...
     * Set to -3 when ride is Refurbishment
     * @type {Number}
     */
    set WaitTime(value) {
    ...
    get Status() {
        ...
        // wait time set to -4 when ride is only accessible with a ticket
        if (this[s_currentWaitTime] == -4) return "Ticket required";

        // wait time set to -3 when ride is in refurbishment/maintenance
